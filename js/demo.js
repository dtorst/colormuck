...
$(document).ready(function () {
  ...
  var showColorsForImage = function($image, $imageSection ) {
    ...
    var colorThiefOutput = {
      ...
      hex: rgbToHex(palette),
      single: singleRGBToHex(color)
    };
    ...
    function colourIsLight(r,g,b) {
      //console.log("colour is light function called");
    ...
    function rgbToHex(rgb) {
      ...
      for (i = 0; i < rgb.length; i++) {
        var rgbhex = {
          ...
          g: rgb[i][1],
          b: rgb[i][2],
          hex: "#" + componentToHex(rgb[i][0]) + componentToHex(rgb[i][1]) + componentToHex(rgb[i][2]),
          name: '',
          textColor: ''
        };

        rgbhex.name = nameMatch(rgbhex.hex);
        rgbhex.textColor = colourIsLight(rgbhex.r,rgbhex.g,rgbhex.b);
        hexArray.push(rgbhex);
      };
    ...
    function singleRGBToHex(rgb) {
      var singleColor = {
        ...
        name: '',
        textColor: colourIsLight(rgb[0],rgb[1],rgb[2])
      };
        singleColor.name = nameMatch(singleColor.hex);
        return singleColor;
    }
